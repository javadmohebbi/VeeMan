...
// GetJobAllBackupSession - Get jobs all backupSessions
func GetJobAllBackupSession(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("content-type", "application/json")
	...
	refs, err := vbemCalls.GetJobAllBackupSessionInfo(objectID, ls.SessionId)
